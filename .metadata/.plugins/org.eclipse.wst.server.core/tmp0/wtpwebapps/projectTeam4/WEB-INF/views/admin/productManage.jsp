                    ...
                    <div class="goods_table_wrap">
	                    ...
	                    <c:if test="${listcheck != 'empty'}">
	                    	<table class="goods_table">
	                    		<thead>
	                    			<tr>
										<td class="th_column_1">상품 아이디</td>
	                    				<td class="th_column_2">업체 아이디</td>
	                    				<td class="th_column_3">상품 이름</td>
	                    				<td class="th_column_4">재고</td>
	                    				<td class="th_column_5">가격</td>
	                    				<td class="th_column_6">할인율</td>
	                    				<td class="th_column_7">최종가격</td>
	                    				<td class="th_column_8">등록날짜</td>
	                    			</tr>
	                    		</thead>	
	                    		<c:forEach items="${list}" var="list">
	                    		<tr>
	                    			<td><c:out value="${list.productId}"></c:out></td>
	                    			<td><c:out value="${list.companyId}"></c:out></td>
	                    			...
	                    			<td><c:out value="${list.lastPrice}"></c:out></td>
